...
export default function ProductDetail() {
  ...
  const {state: {product: {id, image, title, description, category, price, options}}}
    = useLocation();
  const [selected, setSelected] = useState(options && options[0]);//사이즈
      ...
      <section className="flex flex-col md:flex-row p-4">
        ...
        <div className="w-full basis-5/12 flex flex-col p-4">
          ...
          <div className="flex items-center">
            ...
            <select className="p-2 m-4 flex-1 border-2 border-dashed border-brand outline-none" id="select"
